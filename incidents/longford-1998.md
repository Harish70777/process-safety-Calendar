---
title: Longford Esso Gas Plant Explosion
date: 1998-09-25
location: Longford, Victoria, Australia
industry: [natural-gas-processing]
chemicals: [natural-gas, condensate]
severity: 1
fatalities: 2
injuries: 8
...
sources:
  - "Longford Royal Commission Final Report (1999)"
  - "Andrew Hopkins, 'Lessons from Longford' (2000)"
---

## What Happened

Operators at Esso's Longford Gas Plant 1 shut down the flow of warm oil to a heat exchanger without understanding the consequence: the exchanger, no longer receiving the warm oil that kept it from embrittling, cooled dramatically. When operators later tried to restart warm oil flow, the sudden reintroduction of heat caused the now brittle, supercooled metal to fracture, releasing a large quantity of flammable gas and condensate that ignited, killing two workers and injuring eight. The fires burned for two days and cut gas supply to nearly all of Victoria state for about two weeks, causing an estimated $1.3 billion in wider economic impact.
...
- **Reduced engineering supervision:** plant engineers had been relocated away from the site to a central office as a cost-cutting measure, weakening the technical oversight available to catch developing problems.
