...
chemicals: [hydrocarbons, hydrofluoric-acid]
severity: 1
fatalities: 0
injuries: 4
...
While preparing to isolate equipment for maintenance in the fluid catalytic cracking (FCC) unit — idled at the time following an earlier equipment problem — a faulty slide valve failed to keep hydrocarbons separated from the unit's "air side." Hydrocarbons backflowed through the process and ignited inside the electrostatic precipitator (ESP), a piece of pollution-control equipment not designed to contain an explosion. The blast dispersed large quantities of catalyst dust up to a mile from the refinery and threw heavy debris into surrounding units — one piece struck scaffolding in the alkylation unit, narrowly missing a tank holding tens of thousands of pounds of modified hydrofluoric acid (HF), a highly toxic chemical that could have caused a much more severe community-wide release had the tank been breached. Four workers were injured; the refinery ran at reduced capacity for over a year afterward, an outage CSB estimated cost California drivers roughly $2.4 billion in higher gas prices.

## Root Causes

- **Faulty slide valve:** the valve meant to act as a barrier between hydrocarbons and the unit's air side failed to perform that function, the same underlying failure mode later seen at Husky Superior's refinery in 2018.
- **No pre-established safe operating limits or shutdown criteria:** the unit was being operated without clearly defined operating boundaries or a documented threshold for when to shut down rather than continue.
- **Unsafe isolation methods:** CSB found plant personnel used isolation methods for the maintenance work that didn't reliably ensure hydrocarbons were kept out of the area being worked on.
- **Outdated hazard analysis:** the refinery was relying on a procedure carried over from a 2012 maintenance operation without updating the hazard analysis to confirm the same approach remained valid, including whether equipment was being used beyond its predicted safe operating life.
