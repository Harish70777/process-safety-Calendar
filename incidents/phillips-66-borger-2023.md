---
title: Phillips 66 Borger Refinery Natural Gas Liquid Fire
date: 2023-01-17
location: Borger, TX, USA
industry: [oil-gas-refining, natural-gas-storage]
chemicals: [natural-gas-liquid, propane, butane]
severity: 1
fatalities: 1
injuries: 1
root_causes: [tool-left-in-reverse, lockdown-screw-inadvertently-removed, pressurized-residual-material-in-workover-unit, no-hand-tool-requirement]
...
- **A power tool was left configured in reverse:** the impact wrench's direction setting wasn't verified before use on a task requiring tightening, so the tool did the opposite of what the operator intended.
- **A lockdown screw removal released pressurized residual material:** even though the cavern itself was properly isolated, the snubbing unit used for the maintenance work still held pressurized natural gas liquid that hadn't been vented before this final assembly step.
- **No requirement to use hand tools for this precision task:** the facility had not established a practice specifically requiring hand tools (rather than power tools capable of accidentally reversing a fastener) for lockdown screw installation on cavern wellheads.
- **No practice of venting residual pressure from the snubbing unit before final assembly steps:** the unit retained significant pressure through the final stage of the work, when a tool malfunction or human error could still release it.
