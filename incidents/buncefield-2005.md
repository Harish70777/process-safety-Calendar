...
sources:
  - "Buncefield Major Incident Investigation Board Reports"
  - "UK HSE / COMAH investigation"
---
...
- **Instrumentation failure went undetected:** the primary level gauge failed, and the independent high-level switch (the intended safety backup) had also failed without anyone knowing.
- **Inadequate testing of independent protection layers:** safety-critical instrumentation was not proof-tested on a schedule that would have caught the fault.
- **Bund/secondary containment underperformance:** containment systems were not designed for the vapor cloud dynamics of a release this size.
