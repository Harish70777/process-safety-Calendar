---
title: LACC Spent Caustic Release
date: 2020-04-11
location: Westlake, LA, USA
industry: [chemical-manufacturing]
chemicals: [spent-caustic, sodium-hydroxide]
severity: 1
fatalities: 0
injuries: 1
root_causes: [unsecured-manway-hatch, procedure-gap-hose-clearing, no-appropriate-ppe, safety-shower-too-far]
psm_elements: [operating-procedures, mechanical-integrity]
status: published
...
- **An unsecured top hatch gave the pressurized release a path out:** the frac tank's manway was not closed or secured, so when pressurized fluid entered, it had an open route to erupt outward onto the operator instead of staying contained.
- **The written procedure had a real gap:** the company's procedure for clearing the chemical hose didn't address securing the frac tank's top hatch before opening the valve, directly enabling the failure mode that occurred.
- **A temporary workaround became routine use:** the frac tanks were adopted to address a short-term reliability issue with different equipment, but their continued, ongoing use meant a temporary fix was operating under everyday conditions without the same scrutiny a permanent installation might have received.
- **PPE and emergency response infrastructure didn't match the actual hazard distance:** the operator's protective equipment couldn't protect against caustic exposure, and despite a site requirement for a safety shower within 25 feet, the actual distance meant a two-minute delay before she could begin decontamination.
